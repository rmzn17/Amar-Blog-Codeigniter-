                        ...
                        <div class="row">
                            <span style=" font-family: Buxton Sketch;">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-primary pull-left">You are following <?php echo $row['FirstName']; ?>!! but <?php echo $row['FirstName']; ?> is Your Enemy</button>
                                    <?= anchor("Usercontroller/Remove_enemy/{$row['UserName']}", 'Friend', array('class' => 'btn btn-success pull-right', 'data-toggle' => 'tooltip', 'title' => 'Make Enemy This User', 'style' => 'font-family: Buxton Sketch;')) ?>
                                    <?= anchor("Usercontroller/Remove_follower/{$row['UserName']}", 'Unfollow', array('class' => 'btn btn-info pull-right', 'data-toggle' => 'tooltip', 'title' => 'Follow  this user', 'style' => 'font-family: Buxton Sketch;')) ?>
