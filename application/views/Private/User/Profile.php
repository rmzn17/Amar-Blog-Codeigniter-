                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="background-image: url('http://wallpapersdsc.net/wp-content/uploads/2016/03/Charles-Chaplin-Wallpapers.jpg');background-size: 100% 100%;">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <h1 style=" font-family: Forte;" class="text-primary only-bottom-margin"> <?php echo $row['FirstName']; ?></h1>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md8">
                        ...
                        <div class="row">
                            <span style=" font-family: Buxton Sketch;">
                                <div class="col-md-12">
                                    <?= anchor('Usercontroller/Editprofile', 'Edit', array('class' => 'btn btn-primary pull-right glyphicon glyphicon-pencil', 'style' => 'font-family: Buxton Sketch;')) ?>
                        ...
                        <div class="row">
                            <div class="col-md-12 lead">
                                ...
                                <div style=" font-family: Buxton Sketch;float: right">
                                      ...
                                      <a href="#message<?php echo $row['articles_id']; ?>" data-toggle="modal"><button type='button' class="btn btn-danger">Delete Article<span aria-hidden='true'></span></button></a>
                                 ...
                                 <div class="modal fade" id="message<?php echo $row['articles_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="message" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title custom_align" id="Heading">Delete Article</h4>
                                            </div>
                                            <div class="modal-body">

                                                <div class="alert alert-warning"><h3><span class="glyphicon glyphicon-warning-sign"></span> Are you Sure you want to <strong>delete <strong> this article? </h3></p>
                                                </div>
                                                <div class="modal-footer ">

                                                     <?= anchor("Usercontroller/Delete_Article/{$row['articles_id']}", 'Yes', array('class' => 'btn btn-success', 'style' => 'font-family: Buxton Sketch;')) ?>
