                        ...
                        <div class="row">
                            <span style=" font-family: Buxton Sketch;">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-primary pull-left"><?php echo $row['FirstName'];?>  is Your Enemy </button>
                                     <?= anchor("Usercontroller/Remove_enemy/{$row['UserName']}", 'Friend', array('class' => 'btn btn-danger pull-right', 'data-toggle' => 'tooltip','title' => 'Make Enemy This User','style' => 'font-family: Buxton Sketch;')) ?>
