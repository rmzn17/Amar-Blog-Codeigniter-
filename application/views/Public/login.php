            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title text-center"><span style="font-family: Forte;"> Login to Amar Blog </span></div>
                    </div>     
                        ...
                        <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="input-group">
                                ...
                                <span style="font-family: Buxton Sketch;">
                                    <input id="user" type="text" class="form-control" name="uname" value="" placeholder="Username" required="">                                        
                                </span>
                            </div>
